...
public class Tool {
    ...
    // Reference to the objects used to calculate protobuf names:
    @Inject private PbPackages pbPackages;

    // References to the generators:
    @Inject @Any
    private Instance<PbGenerator> generators;
    ...
    public void run(String[] args) throws Exception {
        ...
        pbPackages.setVersion(version);

        // Run the generators:
        if (outDir != null) {
            FileUtils.forceMkdir(outDir);
            for (PbGenerator generator : generators) {
