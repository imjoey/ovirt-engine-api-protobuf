...
/**
 * This class represents the fully qualified name of a protobuf message, composed by the package name and the message.
 */
public class PbClassName {
    ...
    public String getFullName() {
        if (getPackageName() != null) {
            return String.format("%1$s.%2$s", getPackageName(), getSimpleName());
        }
